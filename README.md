...
# 🛠️ Technologies & Technical Ecosystem

## 💻 Programming Languages

`Python` `Java` `JavaScript` `TypeScript` `Dart` `C++`

## 📱 Mobile Development

`Flutter` `React Native` `Firebase` `GetX`
...
- Exploring Android Privacy & Virtualization Techniques
- Building Flutter and Full-Stack Applications
- Expanding Cloud & Backend Development Skills
- Contributing to Security-Focused Software Projects
